...
- **waitingTimeBetweenBatches** - The time in milliseconds between each batch sent. Useful when for further mitigating the `429 - Too Many Requests` error status code.
